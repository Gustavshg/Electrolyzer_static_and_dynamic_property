...
r2=tf.Variable(initial_value=9.943681e-07)
r3=tf.Variable(initial_value=-8.119789e-09)
s1=tf.Variable(initial_value=0.06486329)
s2=tf.Variable(initial_value=0.001324988)
s3=tf.Variable(initial_value=-1.2525138e-05)
t1=tf.Variable(initial_value=0.21508661)
