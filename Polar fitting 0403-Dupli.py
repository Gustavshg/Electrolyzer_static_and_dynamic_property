...
'''原始方程参数'''
r1=tf.Variable(initial_value=1.6589722e-05)
r2=tf.Variable(initial_value=-2.4107499e-07)
r3=tf.Variable(initial_value=2.7535343e-08)
s1=tf.Variable(initial_value=0.064880304)
s2=tf.Variable(initial_value=0.0013408853)
s3=tf.Variable(initial_value=2.2831e-06)
t1=tf.Variable(initial_value=0.21510664)
t2=tf.Variable(initial_value=-19.028326)
