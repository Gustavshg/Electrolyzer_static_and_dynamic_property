...
'''原始方程参数'''
ar1=tf.Variable(initial_value=7.759098e-05)
ar2=tf.Variable(initial_value=8.173941e-06)
ar3=tf.Variable(initial_value=-6.440736e-08)
as1=tf.Variable(initial_value=0.0645596)
as2=tf.Variable(initial_value=0.0003861618)
as3=tf.Variable(initial_value=-2.1838548e-05)
at1=tf.Variable(initial_value=0.19026381)
at2=tf.Variable(initial_value=6.4511757)
at3=tf.Variable(initial_value=3700.711)
br1=tf.Variable(initial_value=6.150415e-05)
br2=tf.Variable(initial_value=3.845287e-07)
br3=tf.Variable(initial_value=-1.4237826e-08)
bs1=tf.Variable(initial_value=0.06504009)
bs2=tf.Variable(initial_value=0.00015039518)
bs3=tf.Variable(initial_value=1.1256178e-05)
bt1=tf.Variable(initial_value=0.19018775)
bt2=tf.Variable(initial_value=-26.770304)
bt3=tf.Variable(initial_value=1202.0524)
