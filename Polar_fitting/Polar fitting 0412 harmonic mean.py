...
'''原始方程参数'''
r1=tf.Variable(initial_value=6.42075e-05)
r2=tf.Variable(initial_value=2.9515732e-07)
r3=tf.Variable(initial_value=1.1371182e-09)
s1=tf.Variable(initial_value=0.06494)
s2=tf.Variable(initial_value=0.0010425115)
s3=tf.Variable(initial_value=-1.1066866e-05)
t1=tf.Variable(initial_value=0.1901984)
t2=tf.Variable(initial_value=-35.045837)
t3=tf.Variable(initial_value=1755.5209)
