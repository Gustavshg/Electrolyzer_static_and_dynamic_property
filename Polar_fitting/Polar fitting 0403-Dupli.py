...
def compare_polar_and_original(V_res,voltage):
    ...
    plt.title('recovered voltage-one var one time SGD 10000')
...
r3=tf.Variable(initial_value=6.138907e-07)
s1=tf.Variable(initial_value=406.08545)
s2=tf.Variable(initial_value=2408.9333)
s3=tf.Variable(initial_value=-73.682076)
t1=tf.Variable(initial_value=7.08834e-08)
t2=tf.Variable(initial_value=-7.9153815e-06)
