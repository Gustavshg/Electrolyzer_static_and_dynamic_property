...
r2=tf.Variable(initial_value=4.2008892e-07)
r3=tf.Variable(initial_value=4.697288e-10)
s1=tf.Variable(initial_value=0.06494)
s2=tf.Variable(initial_value=0.0011580412)
s3=tf.Variable(initial_value=-1.3317274e-05)
t1=tf.Variable(initial_value=0.1901984)
t2=tf.Variable(initial_value=-36.73484)
t3=tf.Variable(initial_value=1853.8292)
