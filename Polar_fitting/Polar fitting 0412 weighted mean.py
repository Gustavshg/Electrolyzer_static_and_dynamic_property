...
r2=tf.Variable(initial_value=3.881836e-07)
r3=tf.Variable(initial_value=-4.3719278e-10)
s1=tf.Variable(initial_value=0.06494)
s2=tf.Variable(initial_value=0.001107715)
s3=tf.Variable(initial_value=-1.2280199e-05)
t1=tf.Variable(initial_value=0.1901984)
t2=tf.Variable(initial_value=-36.361538)
t3=tf.Variable(initial_value=1832.7653)
